...
class VGAE_full(nn.Module):
    def __init__(self):
        super(VGAE_full, self).__init__()
        self.conv1 = GraphConv(args.input_dim3_pery_sign_full, args.h1_pery2, activation=F.relu)
        self.conv2 = GraphConv(args.h1_pery2, args.h2_pery2, activation=F.relu)
...
class VGAE_leakyReLU(nn.Module):
    def __init__(self):
        super(VGAE_leakyReLU, self).__init__()
        self.conv1 = GraphConv(args.input_dim3_pery_sign_full, args.h1_pery2, activation=F.relu)
        self.conv2 = GraphConv(args.h1_pery2, args.h2_pery2, activation=F.relu)
...
class VGAE_ELU(nn.Module):
    def __init__(self):
        super(VGAE_ELU, self).__init__()
        self.conv1 = GraphConv(args.input_dim3_pery_sign_full, args.h1_pery2, activation=F.relu)
        self.conv2 = GraphConv(args.h1_pery2, args.h2_pery2, activation=F.relu)
...
class VGAE_dot(nn.Module):
    def __init__(self):
        super(VGAE_dot, self).__init__()
        self.conv1 = GraphConv(args.input_dim3_pery_sign_full, args.h1_pery2, activation=F.relu)
        self.conv2 = GraphConv(args.h1_pery2, args.h2_pery2, activation=F.relu)
    ...
    def decoder_main(self, z):
        ...
        trans_z = self.dropout(trans_z)
        trans_z = self.relu(trans_z)
        # pred = self.relu(torch.matmul(z, z.t()))
        pred = torch.matmul(z, trans_z.t())
...
class VGAE_dot_conv_leakyrelu(nn.Module):
    def __init__(self):
        ...
        self.conv1 = GraphConv(args.input_dim3_pery_sign_full, args.h1_pery2, activation=F.leaky_relu)
        self.conv2 = GraphConv(args.h1_pery2, args.h2_pery2, activation=F.leaky_relu)
...
class VGAE_dot_conv_leakyrelu_without_multi(nn.Module):
    def __init__(self):
        super(VGAE_dot_conv_leakyrelu_without_multi, self).__init__()
        self.conv1 = GraphConv(args.input_dim3_pery_sign_full, args.h1_pery2, activation=F.leaky_relu)
        self.conv2 = GraphConv(args.h1_pery2, args.h2_pery2, activation=F.leaky_relu)

        self.meanGCN = GraphConv(args.h2_pery2, args.z1_pery2 + args.z2_pery2 + args.z3_pery2, activation=lambda x: x)
        self.logstdGCN = GraphConv(args.h2_pery2, args.z1_pery2 + args.z2_pery2 + args.z3_pery2, activation=lambda x: x)
    ...
    def encoder(self, adj, x):
        ...
        self.mean = self.meanGCN(adj, x2)
        self.logstd  = self.logstdGCN(adj, x2)
